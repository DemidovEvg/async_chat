...
from async_chat.server.admin_ui.server_ui_talk import server_ui_talk
...
class MainWindowContol:
    ...
    def check_server_status(self):
        server_status = server_ui_talk.get_server_status()
    ...
    def start_external_async_loop(self):
        ...
        try:
            ...
            server_ui_talk.put_server_config(config_dto)
...
def main():
    ...
    server_ui_talk.put_window(main_window)
